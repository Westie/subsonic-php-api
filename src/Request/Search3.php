...
use OUTRAGElib\Subsonic\Response\Search3 as ResponseHandler;
 ...
 */
class Search3 extends RequestAbstract
{
	/**
	 * Search query.
	 * @required Yes
	...
	/**
	 * (Since 1.12.0) Only return results from music folder with the given ID. See
	 * getMusicFolders.
	 * @required No
	 */
	...
	{
		return $client->executeRequest("/rest/search3", $this->toArray(), ResponseHandler::class);
	}
}
