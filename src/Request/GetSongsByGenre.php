...
use OUTRAGElib\Subsonic\Response\GetSongsByGenre as ResponseHandler;
...
class GetSongsByGenre extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/getSongsByGenre", $this->toArray(), ResponseHandler::class);
	}
}
