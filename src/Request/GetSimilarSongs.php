...
use OUTRAGElib\Subsonic\Response\GetSimilarSongs as ResponseHandler;
...
class GetSimilarSongs extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/getSimilarSongs", $this->toArray(), ResponseHandler::class);
	}
}
