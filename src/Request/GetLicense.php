...
use OUTRAGElib\Subsonic\Response\GetLicense as ResponseHandler;
 ...
 */
class GetLicense extends RequestAbstract
{
	/**
	...
	{
		return $client->executeRequest("/rest/getLicense", $this->toArray(), ResponseHandler::class);
	}
}
