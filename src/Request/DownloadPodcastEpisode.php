...
use OUTRAGElib\Subsonic\Response\DownloadPodcastEpisode as DownloadPodcastEpisodeResponse;
...
class DownloadPodcastEpisode extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/downloadPodcastEpisode", $this->toArray());
	}
}
