...
use OUTRAGElib\Subsonic\Response\CreatePodcastChannel as ResponseHandler;
...
class CreatePodcastChannel extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/createPodcastChannel", $this->toArray(), ResponseHandler::class);
	}
}
