...
use OUTRAGElib\Subsonic\Response\CreateInternetRadioStation as ResponseHandler;
...
class CreateInternetRadioStation extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/createInternetRadioStation", $this->toArray(), ResponseHandler::class);
	}
}
