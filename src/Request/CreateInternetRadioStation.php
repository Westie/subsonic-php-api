...
use OUTRAGElib\Subsonic\Response\CreateInternetRadioStation as CreateInternetRadioStationResponse;
...
class CreateInternetRadioStation extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/createInternetRadioStation", $this->toArray());
	}
}
