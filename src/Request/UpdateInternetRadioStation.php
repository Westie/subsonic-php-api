...
use OUTRAGElib\Subsonic\Response\UpdateInternetRadioStation as ResponseHandler;
...
class UpdateInternetRadioStation extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/updateInternetRadioStation", $this->toArray(), ResponseHandler::class);
	}
}
