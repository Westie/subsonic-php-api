...
use OUTRAGElib\Subsonic\Response\DeletePodcastEpisode as DeletePodcastEpisodeResponse;
...
class DeletePodcastEpisode extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/deletePodcastEpisode", $this->toArray());
	}
}
