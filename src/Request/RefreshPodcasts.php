...
use OUTRAGElib\Subsonic\Response\RefreshPodcasts as ResponseHandler;
...
class RefreshPodcasts extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/refreshPodcasts", $this->toArray(), ResponseHandler::class);
	}
}
