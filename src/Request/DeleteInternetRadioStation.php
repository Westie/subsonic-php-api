...
use OUTRAGElib\Subsonic\Response\DeleteInternetRadioStation as ResponseHandler;
...
class DeleteInternetRadioStation extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/deleteInternetRadioStation", $this->toArray(), ResponseHandler::class);
	}
}
