...
use OUTRAGElib\Subsonic\Response\DeleteInternetRadioStation as DeleteInternetRadioStationResponse;
...
class DeleteInternetRadioStation extends RequestAbstract
{
	...
	{
		return $client->executeRequest("/rest/deleteInternetRadioStation", $this->toArray());
	}
}
